...
export const getUsers = async (): Promise<AdminUser[]> => (await api.get(API_URL)).data;

export const updateManagedUserRole = async (id: number, role: Role): Promise<AdminUser> => {
